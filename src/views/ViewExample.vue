                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                           <div class="form-group mt-3">
                                              <VJsoneditor v-model="Request" :options="options" :plus="false" height="400px">
                                            </VJsoneditor>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- status code design -->
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade  show active" id="nav-body" role="tabpanel" aria-labelledby="nav-contact-tab">
                                            <div class="form-group mt-3">
                                              <VJsoneditor v-model="Response" :options="options" :plus="false" height="400px">
                                            </VJsoneditor>
                                            </div>
    ...
    data(){
        return{
             active: false,
              ...
              responseBody: {},
              requestBody:  {}, 
              folder_id: this.$store.state.project.callsbyid.folder,
              project_id:  this.$store.state.project.callsbyid.project,
              method: '',
