          ...
          <div class="sidebar-menu">
            <ul>
              ...
              <!-- <li class="sidebar-dropdown"
                ...
                >
                <a style="cursor: pointer"  @click="dropdown(index)">
                  <i class="mdi mdi-folder"></i>
                  <span>{{n.name}}</span>
                  
                </a>

                <div class="sidebar-submenu" v-if="showMe">
                  <ul>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="request"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      sendRequest(event){
        ...
        if(this.valid2 == true){
           ...
           .then((success) =>{
              ...
              this.responseColor = 'success_style'
           })
           .catch((err)=>{
             this.sendOk = false
             ...
             var status = err.response.status
              if(status == 404){
                ...
                this.responseColor = 'error_style'
